...
import styles from './PrescriptionsScreenStyle'
    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={styles.titleStyle}>{'Prescriptions'}</Text>
                {/*{global.isdoctor && <TouchableOpacity style={styles.appoinmentContainer}*/}
